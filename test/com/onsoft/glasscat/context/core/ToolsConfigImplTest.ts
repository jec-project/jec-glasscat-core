...
import { ToolsConfig } from "jec-glasscat-config";

@TestSuite({
  description: "Test the ToolsConfigImpl class properties"
})
export class ToolsConfigImplTest {

  public config:ToolsConfig = null;

  @BeforeAll()
  public initTest():void {
    this.config = new ToolsConfigImpl();
  }
