...
import { EjpSecurityConfig } from "jec-glasscat-config";

@TestSuite({
  description: "Test the EjpSecurityConfigImpl class properties"
})
export class EjpSecurityConfigImplTest {

  public config:EjpSecurityConfig = null;

  @BeforeAll()
  public initTest():void {
    this.config = new EjpSecurityConfigImpl();
  }
