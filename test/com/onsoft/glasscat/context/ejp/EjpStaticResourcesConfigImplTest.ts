...
@TestSuite({
  description: "Test the EjpStaticResourcesConfigImpl class properties"
})
export class EjpStaticResourcesConfigImplTest {

  public config:EjpStaticResourcesConfig = null;

  @BeforeAll()
  public initTest():void {
    this.config = new EjpStaticResourcesConfigImpl();
  }
