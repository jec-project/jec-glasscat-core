...
@TestSuite({
  description: "Test the LoggerManager class log methods when log level is LogLevel.TRACE"
})
export class LoggerManagerTRACETest {
  ...
  public initTest():void {
    ...
    manager.init([this.logger], LogLevel.TRACE);
  }
