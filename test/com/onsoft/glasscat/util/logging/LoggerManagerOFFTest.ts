...
@TestSuite({
  description: "Test the LoggerManager class log methods when log level is LogLevel.OFF"
})
export class LoggerManagerOFFTest {
  ...
  public initTest():void {
    ...
    manager.init([this.logger], LogLevel.OFF);
  }
