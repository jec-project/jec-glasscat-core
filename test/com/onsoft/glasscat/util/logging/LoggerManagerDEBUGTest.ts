...
@TestSuite({
  description: "Test the LoggerManager class log methods when log level is LogLevel.DEBUG"
})
export class LoggerManagerDEBUGTest {
  ...
  public initTest():void {
    ...
    manager.init([this.logger], LogLevel.DEBUG);
  }
