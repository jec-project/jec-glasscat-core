...
@TestSuite({
  description: "Test the LoggerManager class log methods when log level is LogLevel.ERROR"
})
export class LoggerManagerERRORTest {
  ...
  public initTest():void {
    ...
    manager.init([this.logger], LogLevel.ERROR);
  }
